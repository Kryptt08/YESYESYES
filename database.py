...
SEED_PETS = [
    ...
    ("2018 Overlord",     "Permanent Legendary", "0", "0",  None),
    ("Ice Winged Hydra",  "Permanent Legendary", "0", "0",  None),
    ("Diamond Overlord",  "Permanent Legendary", "0", "0",  None),
    ("Valentium",         "Permanent Legendary", "0", "0",  None),
    ("Patriotic Penguin", "Permanent Legendary", "0", "0",  None),
    ("Chocolate Bunny",   "Permanent Legendary", "0", "0",  None),
    ("Super Hexarium",    "Permanent Legendary", "0", "0",  None),
    ("Platinum Overlord", "Permanent Legendary", "0", "0",  None),
    ("Queen Overlord",    "Permanent Legendary", "0", "0",  None),
    ("Radiant Protector", "Permanent Legendary", "0", "0",  None),
    ("Lucky Overlord",    "Permanent Legendary", "0", "0",  None),
    ("Summer Cerberus",   "Permanent Legendary", "0", "0",  None),
    ("Diamond Tamer",     "Permanent Legendary", "0", "0",  None),
    ("King Snowman",      "Permanent Legendary", "0", "0",  None),
    ("Dark Omen",         "Permanent Legendary", "0", "0",  None),
    ("Valentine Shock",   "Permanent Legendary", "0", "0",  None),
]
